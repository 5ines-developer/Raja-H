      ...
      <div id="sidemenu-include">
                <?php $this->load->view('include/menu.php'); ?>
                        ...
                        <div class="col m12 s12 l9">
                            <p class="h5-para black-text ">Add Sub Category - <?php echo str_replace('-', ' ', ucfirst($this->uri->segment(4))) ?></p>

                            <div class="card">
                                <div class="card-content" style="border-top: 2px solid orange;">
                                    <div class="form-container">
                                        <form action="<?php echo base_url() ?>category/sub-insert" method="post"  id="category-form" enctype="multipart/form-data">
                                        
                                          <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="name" name="name" class="validate" required >
                                                  <label for="name">Sub Category<span class="red-text">*</span></label>
