                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-container">
                                        <form action="<?php echo base_url() ?>category/updateSub" method="post"  id="category-form" enctype="multipart/form-data">
                                        
                                          <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="name" name="name" class="validate" required value="<?php echo $result->subcategory ?>">
                                              ...
                                              <input type="hidden" name="cat" value="<?php echo $this->uri->segment(5); ?>">
