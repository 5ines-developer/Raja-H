              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                    ...
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Referrals</p>
                                </div>
                                ...
                                <table id="dynamic" class="striped">
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      <tr>
                                            ...
                                            <td><?php echo $value->friend_email  ?></td>
                                            <td><?php echo date('d M, Y' , strtotime($value->date))  ?></td>

                                            <td class="action-btn  center-align">
                                                <a href="<?php echo base_url('referral/'.$value->id.'') ?>"  class="blue hoverable"><i class="fas fa-eye "></i></i></a>
                                            </td>
