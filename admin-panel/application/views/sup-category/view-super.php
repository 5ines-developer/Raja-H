              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                    ...
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Super Categories - <?php echo str_replace('-', ' ', ucfirst($this->uri->segment(4))) ?> <i class="fa fa-chevron-right grey-text" aria-hidden="true" style="font-size: 14px;"></i> <?php echo str_replace('-', ' ', ucfirst($this->uri->segment(5))) ?></p>
                                </div>
                            </div>
                     ...
                     <!-- chart-table -->
                     <!-- shorting -->
                     <div class="shorting-table" style="border-top: 2px solid brown;">
                        <div>
                                ...
                                <table id="dynamic" class="striped">
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            ...
                                            <td ><?php echo (!empty($value->supercategory))?$value->supercategory:'---'  ?></td>
                                            <td ><?php echo (!empty($value->admin))?$value->admin:'---'  ?></td>

                                            
                                            <td class="action-btn  center-align">
                                              <!-- view user -->
                                                <a href="<?php echo base_url('category/sup-edit/'.$value->supId.'') ?>"  class="blue hoverable"><i class="fas fa-edit "></i></i></a>
                                              <!-- view user -->
                                              <!-- delete user -->
                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('category/sup-delete/'.$value->subId.'/'.$value->supId.'/'.$this->uri->segment(4).'/'.$this->uri->segment(5).'') ?> " class="red hoverable delete-btn"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
