            ...
            <div class="col l12 m12 s12">
                <div class="row">
                    ...
                    <div class="col m12 s12 l9">
                        <p class="h5-para black-text ">Edit SEO -
                            <?php echo (!empty($result->page))?$result->page:''; ?></p>
                                    ...
                                    <div class="form-container">
                                        ...
                                        <div class="row m0">
                                            ...
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="page" name="page" class="validate"
                                                    value="<?php echo (!empty($result->page))?$result->page:''; ?>">
                                                <label for="page">Page <span class="red-text">*</span></label>
                                            </div>

                                            <input type="hidden" id="id" name="id" class="validate"
