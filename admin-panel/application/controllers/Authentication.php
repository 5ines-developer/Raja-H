...
class Authentication extends CI_Controller {
    ...
    public function form_validation()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            if (!empty($data['login'])) {
                ...
                $session_data = array('ra_id' => $id, 'ra_name' => $email,'ra_type' => $type);
    ...
    **/
    ...
    {
        $session_data = array(
            'ra_id' => $this->session->userdata('ra_id'),
    ...
    public function forgot_password()
    {
        ...
        if ($output == '' && $output == FALSE) {
            ...
            $this->email->from($from , 'Raja Housing');
            $this->email->to($email);
            $this->email->subject('forgot password - Raja Housing');
    ...
    {
        $data['title'] = 'admin-Forgot password - Raja Housing';
        $data['id'] = $id;
